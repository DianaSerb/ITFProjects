...
# content > div > h4 > em:nth-child(2)

flash_message = driver.find_element(*ERROR).text  # preluam textul
...
driver.quit()
#TODO extragere dinamica de user si parola in alta varianta
#TODO migrare in clase cu unittest